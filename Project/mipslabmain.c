...
void celsiusMaxTemp(int time);			//Calculate the max temp over a given intervall(seconds)
...
void measurements(void)
{
  ...
  else if ((buttons & 4) && mtype1 == 1) // button4
	{
		while (mtype1 == 1)
		{
	 		celciusAverage(10);
	...
	else if ((buttons & 2) && mtype1 == 1) // button3
	{
		while (mtype1 == 1)
		{
	 		celciusMaxTemp(10);
